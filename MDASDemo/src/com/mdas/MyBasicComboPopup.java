...
public class MyBasicComboPopup extends JPopupMenu implements ComboPopup {
...
//        comboBox.unregisterKeyboardAction( KeyStroke.getKeyStroke( KeyEvent.VK_ENTER, 0 ) );
    ...
    protected void configureList() {
        ...
        list.setSelectionForeground(MyColorUtils.getColor(MyColor.MAIN_YELLOW));
        list.setSelectionBackground(MyColorUtils.getColor(MyColor.MAIN_DARK));
        list.setBorder( null );

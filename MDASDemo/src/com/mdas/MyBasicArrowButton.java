...
public class MyBasicArrowButton extends JButton implements SwingConstants
{
        /**
	 * 
	 */
	private static final long serialVersionUID = -2735157267248081681L;
...
//        private Color highlight;
         ...
         * @since 1.4
         */
        public MyBasicArrowButton(int direction, Color background, Color triangle) {
            super();
        ...
        public MyBasicArrowButton(int direction) {
            this(direction, MyColorUtils.getColor(MyColor.MAIN_GREY_PANEL), Color.WHITE);
        }
